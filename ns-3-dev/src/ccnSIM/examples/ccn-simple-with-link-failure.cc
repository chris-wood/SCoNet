 ...
 */
// ccn-simple-with-link-failure.cc
...
#include "ns3/ccn-link-control-helper.h"
...
main (int argc, char *argv[])
{
  ...
  Simulator::Schedule (Seconds (10.0), ccn::LinkControlHelper::FailLink, nodes.Get (0), nodes.Get (1));
  Simulator::Schedule (Seconds (15.0), ccn::LinkControlHelper::UpLink,   nodes.Get (0), nodes.Get (1));   
