...
main (int argc, char *argv[])
{
  ...
  topologyReader.SetFileName ("src/ccnSIM/examples/topologies/topo-11-node-two-bottlenecks.txt");
  topologyReader.Read ();

  // Install CCN stack on all nodes
  ccn::StackHelper ccnHelper;
  ccnHelper.SetForwardingStrategy ("ns3::ccn::fw::CustomStrategy");
  ...
  ccn::StackHelper::AddRoute	("c1", "/data", "n1", 1, 1); // link to n1
  ccn::StackHelper::AddRoute	("c2", "/data", "n1", 1, 1); // link to n1
  ccn::StackHelper::AddRoute	("c3", "/data", "n1", 1, 1); // link to n1
  ccn::StackHelper::AddRoute	("c4", "/data", "n1", 1, 1); // link to n1

  ccn::StackHelper::AddRoute	("n1", "/data", "n2", 1, 1); // link to n2
  ccn::StackHelper::AddRoute	("n1", "/data", "n12", 2, 1); // link to n12

  ccn::StackHelper::AddRoute	("n12", "/data", "n2", 1, 1); // link to n2

  ccn::StackHelper::AddRoute	("n2", "/data/p1", "p1", 1, 1); // link to p1
  ccn::StackHelper::AddRoute	("n2", "/data/p2", "p2", 1, 1); // link to p2
  ccn::StackHelper::AddRoute	("n2", "/data/p3", "p3", 1, 1); // link to p3
  ccn::StackHelper::AddRoute	("n2", "/data/p4", "p4", 1, 1); // link to p4
