 ...
 * 
 *     NS_LOG=DumbRequester ./waf --run ccn-simple-with-content-freshness
 */
...
main (int argc, char *argv[])
{
  ...
  ccnxHelper.SetContentStore ("ns3::ccn::cs::UtilityCaching",
  ...
  // Consumer
  ccn::AppHelper consumerHelper ("DumbRequester");
