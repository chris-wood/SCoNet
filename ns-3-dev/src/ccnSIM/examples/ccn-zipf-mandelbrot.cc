 ...
 *
 *     NS_LOG=ccn.Consumer:ccn.ConsumerZipfMandelbrot:ccn.Producer ./waf --run=ccn-zipf-mandelbrot
 */

int
main (int argc, char *argv[])
{
  //LogComponentEnable("ccn.CbisGlobalRoutingHelper", LOG_LEVEL_INFO);
  ...
  ccnxHelper.SetForwardingStrategy ("ns3::ccn::fw::SmartFlooding");
  ccnxHelper.SetContentStore ("ns3::ccn::cs::Lru", "MaxSize", "10");
  ccnxHelper.InstallAll ();

  // Installing global routing interface on all nodes
  //ccn::CbisGlobalRoutingHelper ccnxGlobalRoutingHelper;
