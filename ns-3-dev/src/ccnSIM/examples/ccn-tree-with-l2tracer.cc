...
main (int argc, char *argv[])
{
  ...
  topologyReader.SetFileName ("src/ccnSIM/examples/topologies/topo-tree-25-node.txt");
  topologyReader.Read ();
  
  /****************************************************************************/
  // Install CCNx stack on all nodes
  ccn::StackHelper ccnxHelper;
  ccnxHelper.SetContentStore ("ns3::ccn::cs::Lru", "MaxSize", "1000");
  ccnxHelper.SetForwardingStrategy ("ns3::ccn::fw::BestRoute");
