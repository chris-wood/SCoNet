 ...
 *
 *     NS_LOG=ccn.Consumer:ccn.Producer ./waf --run=ccn-simple-udp
 */
...
main (int argc, char *argv[])
{
  ...
  ccn::IpFacesHelper::InstallAll ();
  ccn::IpFacesHelper::CreateUdpFace (Seconds (1.0), nodes.Get (0), Ipv4Address ("10.1.2.2"), "/udp-route1");
  ccn::IpFacesHelper::CreateUdpFace (Seconds (1.0), nodes.Get (0), Ipv4Address ("10.1.1.2"), "/udp-route2");
