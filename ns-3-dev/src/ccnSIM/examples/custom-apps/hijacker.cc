...
void
Hijacker::OnInterest (Ptr<const ccn::Interest> interest)
{
  ccn::App::OnInterest (interest); // forward call to perform app-level tracing
...
Hijacker::StartApplication ()
{
  ...
  Ptr<ccn::fib::Entry> fibEntry = fib->Add (ccn::Name ("/"), m_face, 0, 0);
