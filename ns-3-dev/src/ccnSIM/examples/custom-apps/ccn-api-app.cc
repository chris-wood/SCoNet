...
#include "ccn-api-app.h"

NS_LOG_COMPONENT_DEFINE ("ccn.ApiApp");

namespace ns3 {
namespace ccn {

// Necessary if you are planning to use ccn::AppHelper
NS_OBJECT_ENSURE_REGISTERED (ApiApp);

TypeId
ApiApp::GetTypeId ()
{
  static TypeId tid = TypeId ("ns3::ccn::ApiApp")
...
ApiApp::StartApplication ()
{
  ...
  Simulator::Schedule (Seconds (1), &::ns3::ccn::ApiApp::RequestData, this);
  Simulator::Schedule (Seconds (10), &::ns3::ccn::ApiApp::RequestData, this);
}
