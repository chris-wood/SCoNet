...
#ifndef CCN_CCNCXX_DETAIL_PENDING_INTEREST_CONTAINER_H
#define CCN_CCNCXX_DETAIL_PENDING_INTEREST_CONTAINER_H
...
struct PendingInterestContainer :
    public ccnSIM::trie_with_policy<Name,
                                    ccnSIM::smart_pointer_payload_traits< PendingInterestEntry >,
...
#endif // CCN_CCNCXX_DETAIL_PENDING_INTEREST_CONTAINER_H
