...
NS_LOG_COMPONENT_DEFINE ("ccn.ApiFace");
...
ApiFace::SetInterestFilter (Ptr<const Name> prefix, InterestCallback onInterest)
{
  ...
  Ptr<ccn::fib::Entry> fibEntry = fib->Add (prefix, this, 0, 0);
  fibEntry->UpdateStatus (this, ccn::fib::FaceMetric::CCN_FIB_GREEN);
}
...
{
  // data has been send out from CCN stack towards the application
