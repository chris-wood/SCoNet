# -*- coding: utf-8 -*-
#
# ccnSIM: NS-3 based CCN simulator documentation build configuration file, created by
...
htmlhelp_basename = 'ccnSIMNS-3basedCCNsimulatordoc'
...
latex_documents = [
  ('tutorial', 'ccnSIM-tutorial.tex', u'ccnSIM: NS-3 based Named Data Networking (CCN) simulator documentation',
...
man_pages = [
    ('index', 'ccnSIM', u'ccnSIM: NS-3 based Named Data Networking (CCN) simulator documentation',
...
texinfo_documents = [
  ('index', 'ccnSIM', u'ccnSIM: NS-3 based Named Data Networking (CCN) simulator documentation',
   u'Alexander Afanasyev, Ilya Moiseenko, and Lixia Zhang', 'ccnSIM', 'One line description of project.',
   'Miscellaneous'),
]
