...
#ifndef CCN_CONSUMER_ZIPF_MANDELBROT_H_
#define CCN_CONSUMER_ZIPF_MANDELBROT_H_
...
/**
 * @ingroup ccn-apps
 * @brief CCN app requesting contents following Zipf-Mandelbrot Distbituion
 *
...
#endif /* CCN_CONSUMER_ZIPF_MANDELBROT_H_ */
