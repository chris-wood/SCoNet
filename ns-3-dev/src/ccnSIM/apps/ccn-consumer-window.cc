...
NS_LOG_COMPONENT_DEFINE ("ccn.ConsumerWindow");
...
{
  static TypeId tid = TypeId ("ns3::ccn::ConsumerWindow")
    .SetGroupName ("Ccn")
    .SetParent<Consumer> ()
...
void
ConsumerWindow::OnInterestResponse (Ptr<const InterestResponse> interestResponse)
{
  Consumer::OnInterestResponse (interestResponse);
