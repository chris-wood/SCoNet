...
class Interest (object):
    ...
    def __init__(self,
        ...
        if interest:
            ...
            elif isinstance (interest, ns.ccnSIM.ccn.Interest):
                self._interest = interest
            else:
                raise TypeError ("Invalid type supplied for 'interest' parameter [%s]" % type (interest))
        else:
            self._interest = ns.ccnSIM.ccn.Interest ()
    ...
    @staticmethod
    def fromWire (wire):
        return Interest (interest = ns.ccnSIM.ccn.Wire.ToInterestStr (wire))

    def toWire (self):
        return ns.ccnSIM.ccn.Wire.FromInterestStr (self._interest)
    ...
    def __setattr__(self, name, value):
        if name == "_interest":
            ...
            if value is None:
                return self._interest.SetName (ns.ccnSIM.ccn.Name ())
                ...
                return self._interest.SetName (ns.ccnSIM.ccn.Name (value))
            else:
    ...
    def __repr__(self):
        return "ccnSIM.Interest(%s)" % str (self._interest)
