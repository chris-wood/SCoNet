...
#include "ccn-rtt-mean-deviation.h"
...
NS_LOG_COMPONENT_DEFINE ("ccn.RttMeanDeviation");

namespace ns3 {
namespace ccn {

//---------------------------------------------------------------------------------
// A modified version of Mean-Deviation Estimator optimized for CCN packet delivery
...
{
  static TypeId tid = TypeId ("ns3::ccn::RttMeanDeviation")
