...
NS_LOG_COMPONENT_DEFINE ("ccn.L3RateTracer");
...
L3RateTracer::OutInterests  (Ptr<const Interest> interest, Ptr<const Face> face)
{
  ...
  if (interest->GetTlv ())
    {
      m_stats[face].get<1> ().m_outInterests += (interest->GetTlv ())->GetSerializedSize ();
    }
}
...
L3RateTracer::InInterests   (Ptr<const Interest> interest, Ptr<const Face> face)
{
  ...
  if (interest->GetTlv ())
    {
      m_stats[face].get<1> ().m_inInterests += (interest->GetTlv ())->GetSerializedSize ();
    }
}
...
L3RateTracer::DropInterests (Ptr<const Interest> interest, Ptr<const Face> face)
{
  ...
  if (interest->GetTlv ())
    {
      m_stats[face].get<1> ().m_dropInterests += (interest->GetTlv ())->GetSerializedSize ();
    }
}
...
L3RateTracer::OutNacks  (Ptr<const Interest> interest, Ptr<const Face> face)
{
  ...
  if (interest->GetTlv ())
    {
      m_stats[face].get<1> ().m_outNacks += (interest->GetTlv ())->GetSerializedSize ();
    }
}
...
L3RateTracer::InNacks   (Ptr<const Interest> interest, Ptr<const Face> face)
{
  ...
  if (interest->GetTlv ())
    {
      m_stats[face].get<1> ().m_inNacks += interest->GetTlv ()->GetSerializedSize ();
    }
}
...
L3RateTracer::DropNacks (Ptr<const Interest> interest, Ptr<const Face> face)
{
  ...
  if (interest->GetTlv ())
    {
      m_stats[face].get<1> ().m_dropNacks += interest->GetTlv ()->GetSerializedSize ();
    }
}
                        ...
                        bool fromCache, Ptr<const Face> face)
{
  ...
  if (data->GetTlv ())
    {
      m_stats[face].get<1> ().m_outData += data->GetTlv ()->GetSerializedSize ();
    }
}
                        ...
                        Ptr<const Face> face)
{
  ...
  if (data->GetTlv ())
    {
      m_stats[face].get<1> ().m_inData += data->GetTlv ()->GetSerializedSize ();
    }
}
                        ...
                        Ptr<const Face> face)
{
  ...
  if (data->GetTlv ())
    {
      m_stats[face].get<1> ().m_dropData += data->GetTlv ()->GetSerializedSize ();
    }
}
