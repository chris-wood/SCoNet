...
#ifndef CCN_L3_TRACER_H
#define CCN_L3_TRACER_H
...
/**
 * @ingroup ccn-helpers
 * @defgroup ccn-tracers Helpers to simplify metric collection
 */
...
/**
 * @ingroup ccn-tracers
 * @brief Base class for network-layer (incoming/outgoing Interests and Data) tracing of CCN stack
 */
