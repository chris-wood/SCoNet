...
#ifndef CCN_L3_AGGREGATE_TRACER_H
#define CCN_L3_AGGREGATE_TRACER_H

#include "ccn-l3-tracer.h"
...
/**
 * @ingroup ccn-tracers
 * @brief CCN network-layer tracer for aggregate packet counts
 */
...
#endif // CCN_L3_AGGREGATE_TRACER_H
