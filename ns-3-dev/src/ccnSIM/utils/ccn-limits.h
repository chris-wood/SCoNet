...
#ifndef _CCN_LIMITS_H_
#define	_CCN_LIMITS_H_
...
public:
   ...
   *
   * Note that interpretation of this value may be different in different ccn::Limit realizations
   *
