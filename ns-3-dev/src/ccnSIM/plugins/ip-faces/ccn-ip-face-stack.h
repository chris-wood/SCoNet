...
#ifndef CCN_IP_FACE_STACK_H
#define CCN_IP_FACE_STACK_H
...
/**
 * @ingroup ccn
 * @brief Application that provides functionality of creating IP-based faces on CCN nodes
 *
