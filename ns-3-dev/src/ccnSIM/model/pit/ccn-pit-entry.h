...
#ifndef _CCN_PIT_ENTRY_H_
#define _CCN_PIT_ENTRY_H_
...
#include "ns3/ccn-pit-entry-incoming-face.h"
#include "ns3/ccn-pit-entry-outgoing-face.h"
...
/*  virtual void
  ...
  /**
     * @brief Get hop count assumed by router when forwarding interest
     */
uint32_t
GetHopCount () const;
    ...
    /**
       * @brief Set hop count assumed by router when forwarding interest
       */
void
...
//  nonce_container m_seenNonces;  ///< \brief map of nonces that were seen for this prefix
  ...
  uint32_t m_hopCount;   ///< @brief Hop Count assumed by router when forwarding interest
