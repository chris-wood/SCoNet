...
namespace wire
{
  namespace icnx
  {
    ...
    TLV_EC_SECP256K1::TLV_EC_SECP256K1 ()
    {
      m_serializedDataPtr = NULL;
      m_DataPtr = NULL;
      m_length = 0;
      m_type = EC_SECP256K1_TLV;
      m_dataChanged = true;
    ...
    TLV_EC_SECP256K1::TLV_EC_SECP256K1 (const TLV_EC_SECP256K1 & tlv_msg)
      :TLV_RAWDATA(tlv_msg)
    {
      //m_serializedDataPtr = NULL;
     // m_DataPtr = NULL;
    ...
    TLV_EC_SECP256K1::TLV_EC_SECP256K1 (const std::string & xmlString)
      :TLV_RAWDATA(xmlString)
    {
     // m_serializedDataPtr = NULL;
     // m_DataPtr = NULL;
     // m_type = MSG_NAME_EC_SECP256K1_TLV;
      //XmlImplement (xmlString);
    }

    TLV_EC_SECP256K1::TLV_EC_SECP256K1 (const TLV_RAW_DATA_t * rawData)
      :TLV_RAWDATA(rawData)
    {
      //m_serializedDataPtr = NULL;
     // m_DataPtr = NULL;
    ...
    TLV_EC_SECP256K1::TLV_EC_SECP256K1 (TLV_TYPE_t type, TLV_LENGTH_t length,
 ...
 const std::string 
 TLV_EC_SECP256K1::tlvIdName() const { return std::string("TLV_EC_SECP256K1"); }


    TLV_EC_SECP256K1 & TLV_EC_SECP256K1::operator = (const TLV_EC_SECP256K1 & other)
    {
    ...
    TLV_BASE * 
    TLV_EC_SECP256K1::Copy() const
    {
         return new TLV_EC_SECP256K1( *this); 
    }
...
#ifdef _SELF_TEST_TLV_EC_SECP256K1_
#include <streambuf>
#include <ostream>
#include <iostream>
...
main ()
{
  ...
  wire::icnx::TLV_EC_SECP256K1 a;
  const uint8_t *var =
    reinterpret_cast < const uint8_t * >("ABCDEFGHIJKLMNOPQRSTUVXYZ");
  wire::icnx::TLV_EC_SECP256K1 b (257, 26, var); //add 1 for NULL for strings
  wire::icnx::TLV_EC_SECP256K1 c (b);

  wire::icnx::TLV_EC_SECP256K1 d (b.NetworkSerialize ());
  wire::icnx::TLV_EC_SECP256K1 e (b.XmlPrint ());

  wire::icnx::TLV_EC_SECP256K1 f;
  f.SetData ("0123456789");
  wire::icnx::TLV_EC_SECP256K1 *g = new wire::icnx::TLV_EC_SECP256K1;
  *g = f;
