...
#ifndef _CCN_TLV_HMAC_SHA256_H_
#define _CCN_TLV_HMAC_SHA256_H_
/* CCN 1.0 TLV HMAC-SHA256 HDR packet
                    1                   2                   3
 ...
 **/
    class TLV_HMAC_SHA256:public TLV_RAWDATA
    {
    public:
   ...
   **/
      TLV_HMAC_SHA256 (const TLV_HMAC_SHA256 & tlv_msg);

  /**
   * @brief Copy constructor from serialized byte data
   **/
        TLV_HMAC_SHA256 (const TLV_RAW_DATA_t * rawData);

    /**
   * @brief Copy constructor from XML formatted string 
   **/
        TLV_HMAC_SHA256 (const std::string & xmlString);

  /**
    * @brief Copy constructor from type, length and raw data information
    **/
        TLV_HMAC_SHA256 (TLV_TYPE_t type, TLV_LENGTH_t length,
 ...
 tlvIdName() const;
  ...
  /**
    ...
    *
    **/
      virtual TLV_HMAC_SHA256 & operator = (const TLV_HMAC_SHA256 & other);
