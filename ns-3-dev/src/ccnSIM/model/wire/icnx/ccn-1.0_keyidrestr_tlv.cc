...
namespace wire
{
  namespace icnx
  {
    ...
    TLV_KEYIDRESTR::TLV_KEYIDRESTR ()
    {
      m_serializedDataPtr = NULL;
      m_DataPtr = NULL;
      m_length = 0;
      m_type = KEYIDRESTR_TLV;
      m_dataChanged = true;
    ...
    TLV_KEYIDRESTR::TLV_KEYIDRESTR (const TLV_KEYIDRESTR & tlv_msg)
      :TLV_RAWDATA(tlv_msg)
    {
      //m_serializedDataPtr = NULL;
     // m_DataPtr = NULL;
    ...
    TLV_KEYIDRESTR::TLV_KEYIDRESTR (const std::string & xmlString)
    ...
    TLV_KEYIDRESTR::TLV_KEYIDRESTR (const TLV_RAW_DATA_t * rawData)
      :TLV_RAWDATA(rawData)
    {
      //m_serializedDataPtr = NULL;
      //m_DataPtr = NULL;
    ...
    TLV_KEYIDRESTR::TLV_KEYIDRESTR (TLV_TYPE_t type, TLV_LENGTH_t length,
 ...
 const std::string 
 TLV_KEYIDRESTR::tlvIdName() const { return std::string("TLV_KEYIDRESTR"); }


    TLV_KEYIDRESTR & 
      TLV_KEYIDRESTR::operator = (const TLV_KEYIDRESTR & other)
    {
    ...
    TLV_BASE * 
    TLV_KEYIDRESTR::Copy() const
    {
         return new TLV_KEYIDRESTR( *this); 
    }
...
#ifdef _SELF_TEST_TLV_KEYIDRESTR_
#include <streambuf>
#include <ostream>
#include <iostream>
...
main ()
{
  ...
  wire::icnx::TLV_KEYIDRESTR a;
  const uint8_t *var =
    reinterpret_cast < const uint8_t * >("ABCDEFGHIJKLMNOPQRSTUVXYZ");
  wire::icnx::TLV_KEYIDRESTR b (257, 26, var); //add 1 for NULL for strings
  wire::icnx::TLV_KEYIDRESTR c (b);

  wire::icnx::TLV_KEYIDRESTR d (b.NetworkSerialize ());
  wire::icnx::TLV_KEYIDRESTR e (b.XmlPrint ());

  wire::icnx::TLV_KEYIDRESTR f;
  f.SetData ("0123456789");
  wire::icnx::TLV_KEYIDRESTR *g = new wire::icnx::TLV_KEYIDRESTR;
  *g = f;
  ...
  wire::icnx::TLV_KEYIDRESTR * h = new wire::icnx::TLV_KEYIDRESTR (5, 10, array);
  wire::icnx::TLV_KEYIDRESTR * j = new wire::icnx::TLV_KEYIDRESTR (*h);
