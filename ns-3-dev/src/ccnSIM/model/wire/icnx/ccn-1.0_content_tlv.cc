...
namespace wire
{
  namespace icnx
  {
    ...
    TLV_CONTENT::TLV_CONTENT (const TLV_CONTENT & tlv_msg)
      : TLV_TLVDATA(tlv_msg)
    {
      //m_serializedDataPtr = NULL;
      //CopyFromTlv (tlv_msg);
    ...
    TLV_CONTENT::TLV_CONTENT (const TLV_RAW_DATA_t * rawData)
      :TLV_TLVDATA(rawData)
    {
      //m_serializedDataPtr = NULL;
    ...
    TLV_CONTENT::TLV_CONTENT (TLV_TYPE_t type, TLV_LENGTH_t length,
    ...
    TLV_CONTENT::TLV_CONTENT (const std::list<TLV_BASE *> &tlvDataList)
    ...
    TLV_CONTENT::TLV_CONTENT (const std::string & xmlString)
 ...
 const std::string 
 TLV_CONTENT::tlvIdName() const { return std::string("TLV_CONTENT"); }

    TLV_CONTENT & TLV_CONTENT::operator = (const TLV_CONTENT & other)
    {
    ...
    TLV_BASE * 
    TLV_CONTENT::Copy() const
    {
         return new TLV_CONTENT( *this); 
    }
...
main ()
{
  ...
  wire::icnx::TLV_CONTENT *b= new wire::icnx::TLV_CONTENT();
  {
  ...
  wire::icnx::TLV_CONTENT *e = new wire::icnx::TLV_CONTENT();
  e->SetData(new wire::icnx::TLV_CONTENT(*b));
  wire::icnx::TLV_CONTENT *d = new wire::icnx::TLV_CONTENT();
  d->SetTlvData(copy);
  ...
  wire::icnx::TLV_CONTENT *g1 = new wire::icnx::TLV_CONTENT (d->NetworkSerialize ());
  g1->CreateSerializedBuffer ();
  g1->XmlPrint (std::cout);
  g1->NetworkSerializePrint (std::cout, 4, " ");

  wire::icnx::TLV_CONTENT *g2 = new wire::icnx::TLV_CONTENT(d->XmlPrint ());
  ...
  wire::icnx::TLV_CONTENT *g = new wire::icnx::TLV_CONTENT (e->NetworkSerialize ());
  wire::icnx::TLV_CONTENT *h = new wire::icnx::TLV_CONTENT(e->XmlPrint ());
  cout << "delete e" << endl;
  delete e;
