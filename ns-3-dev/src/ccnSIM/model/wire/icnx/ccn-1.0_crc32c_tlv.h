...
#ifndef _CCN_TLV_CRC32C_H_
#define _CCN_TLV_CRC32C_H_
/* CCN 1.0 TLV CRC32C HDR packet
                    1                   2                   3
 ...
 **/
    class TLV_CRC32C:public TLV_RAWDATA
    {
    public:
 ...
 tlvIdName() const;
  ...
  /**
    ...
    *
    **/
      virtual TLV_CRC32C & operator = (const TLV_CRC32C & other);
