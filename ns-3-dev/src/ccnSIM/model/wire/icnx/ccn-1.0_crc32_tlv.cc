...
namespace wire
{
  namespace icnx
  {
    ...
    TLV_CRC32::TLV_CRC32 (const TLV_CRC32 & tlv_msg)
      :TLV_RAWDATA(tlv_msg)
    {
      //m_serializedDataPtr = NULL;
     // m_DataPtr = NULL;
    ...
    TLV_CRC32::TLV_CRC32 (const std::string & xmlString)
      :TLV_RAWDATA(xmlString)
    {
     // m_serializedDataPtr = NULL;
     // m_DataPtr = NULL;
     // m_type = MSG_NAME_CRC32_TLV;
      //XmlImplement (xmlString);
    }

    TLV_CRC32::TLV_CRC32 (const TLV_RAW_DATA_t * rawData)
      :TLV_RAWDATA(rawData)
    {
      //m_serializedDataPtr = NULL;
     // m_DataPtr = NULL;
    ...
    TLV_CRC32::TLV_CRC32 (TLV_TYPE_t type, TLV_LENGTH_t length,
 ...
 const std::string 
 TLV_CRC32::tlvIdName() const { return std::string("TLV_CRC32"); }

    TLV_BASE * 
    TLV_CRC32::Copy() const
    {
         return new TLV_CRC32( *this); 
    }

    TLV_CRC32 & TLV_CRC32::operator = (const TLV_CRC32 & other)
    {
...
main ()
{
  ...
  wire::icnx::TLV_CRC32 a;
  const uint8_t *var =
    reinterpret_cast < const uint8_t * >("ABCDEFGHIJKLMNOPQRSTUVXYZ");
  wire::icnx::TLV_CRC32 b (257, 26, var); //add 1 for NULL for strings
  wire::icnx::TLV_CRC32 c (b);

  wire::icnx::TLV_CRC32 d (b.NetworkSerialize ());
  wire::icnx::TLV_CRC32 e (b.XmlPrint ());

  wire::icnx::TLV_CRC32 f;
  f.SetData ("0123456789");
  wire::icnx::TLV_CRC32 *g = new wire::icnx::TLV_CRC32;
  *g = f;
