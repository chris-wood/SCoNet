...
#ifndef _CCN_TLV_PAD_H_
#define _CCN_TLV_PAD_H_
/* CCN 1.0 TLV DATA PAD HDR packet
                    1                   2                   3
 ...
 **/
    class TLV_PAD:public TLV_RAWDATA
    {
    public:
...
/**
 ...
 tlvIdName() const;
  ...
  /**
    ...
    *
    **/
      virtual TLV_PAD & operator = (const TLV_PAD & other);
