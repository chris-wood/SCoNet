...
#ifndef _CCN_TLV_IPID_H_
#define _CCN_TLV_IPID_H_
/* CCN 1.0 TLV DATA IPID HDR packet
                    1                   2                   3
 ...
 **/
    class TLV_IPID:public TLV_RAWDATA
    {
    public:
...
/**
 ...
 tlvIdName() const;
  ...
  /**
    ...
    *
    **/
      virtual TLV_IPID & operator = (const TLV_IPID & other);
