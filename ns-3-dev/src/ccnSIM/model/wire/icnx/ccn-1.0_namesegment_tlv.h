...
#ifndef _CCN_TLV_NAMESEG_H_
#define _CCN_TLV_NAMESEG_H_
/* CCN 1.0 TLV NAME SEGMENT HDR packet
                    1                   2                   3
 ...
 **/
    class TLV_NAMESEG:public TLV_RAWDATA
    {
    public:
   ...
   **/
      TLV_NAMESEG (const TLV_NAMESEG & tlv_msg);

  /**
   * @brief Copy constructor from serialized byte data
   **/
        TLV_NAMESEG (const TLV_RAW_DATA_t * rawData);

    /**
   * @brief Copy constructor from XML formatted string 
   **/
        TLV_NAMESEG (const std::string & xmlString);

  /**
    * @brief Copy constructor from type, length and raw data information
    **/
        TLV_NAMESEG (TLV_TYPE_t type, TLV_LENGTH_t length,
 ...
 tlvIdName() const;
  ...
  /**
    ...
    *
    **/
      virtual TLV_NAMESEG & operator = (const TLV_NAMESEG & other);
