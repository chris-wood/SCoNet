...
#ifndef _CCN_TLV_INTERESTRESPONSE_H_
#define _CCN_TLV_INTERESTRESPONSE_H_
/* CCN 1.0 TLV  Interest HDR packet
                    1                   2                   3
 ...
 **/
    class TLV_INTERESTRESPONSE:public TLV_TLVDATA
    {
    public:
   ...
   **/
      TLV_INTERESTRESPONSE (const TLV_INTERESTRESPONSE & tlv_msg);
      
   /**
   * @brief Copy constructor from serialized byte data
   **/
      TLV_INTERESTRESPONSE (const TLV_RAW_DATA_t * rawData);
      
  /**
    * @brief Copy constructor from type, length and raw data information
    **/
      TLV_INTERESTRESPONSE (TLV_TYPE_t type, TLV_LENGTH_t length,
                     const TLV_RAW_DATA_t * data);
      
  /**
    * @brief Copy constructor from a list of TLVs
    **/
      TLV_INTERESTRESPONSE (const std::list<TLV_BASE *> &tlvDataList);
      
            /**
   * @brief Copy constructor from XML formatted string 
   **/
      TLV_INTERESTRESPONSE (const std::string & xmlString);
...
/**
 ...
 tlvIdName() const;
  ...
  /**
    ...
    *
    **/
      virtual TLV_INTERESTRESPONSE & operator = (const TLV_INTERESTRESPONSE & other);
