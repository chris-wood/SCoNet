...
namespace wire
{
  namespace icnx
  {
    ...
    TLV_RSA_SHA256::TLV_RSA_SHA256 ()
    {
      m_serializedDataPtr = NULL;
      m_DataPtr = NULL;
      m_length = 0;
      m_type = RSA_SHA256_TLV;
      m_dataChanged = true;
    ...
    TLV_RSA_SHA256::TLV_RSA_SHA256 (const TLV_RSA_SHA256 & tlv_msg)
      :TLV_RAWDATA(tlv_msg)
    {
      //m_serializedDataPtr = NULL;
     // m_DataPtr = NULL;
    ...
    TLV_RSA_SHA256::TLV_RSA_SHA256 (const std::string & xmlString)
      :TLV_RAWDATA(xmlString)
    {
     // m_serializedDataPtr = NULL;
     // m_DataPtr = NULL;
     // m_type = MSG_NAME_RSA_SHA256_TLV;
      //XmlImplement (xmlString);
    }

    TLV_RSA_SHA256::TLV_RSA_SHA256 (const TLV_RAW_DATA_t * rawData)
      :TLV_RAWDATA(rawData)
    {
      //m_serializedDataPtr = NULL;
     // m_DataPtr = NULL;
    ...
    TLV_RSA_SHA256::TLV_RSA_SHA256 (TLV_TYPE_t type, TLV_LENGTH_t length,
 ...
 const std::string 
 TLV_RSA_SHA256::tlvIdName() const { return std::string("TLV_RSA_SHA256"); }


    TLV_RSA_SHA256 & TLV_RSA_SHA256::operator = (const TLV_RSA_SHA256 & other)
    {
    ...
    TLV_BASE * 
    TLV_RSA_SHA256::Copy() const
    {
         return new TLV_RSA_SHA256( *this); 
    }
...
#ifdef _SELF_TEST_TLV_RSA_SHA256_
#include <streambuf>
#include <ostream>
#include <iostream>
...
main ()
{
  ...
  wire::icnx::TLV_RSA_SHA256 a;
  const uint8_t *var =
    reinterpret_cast < const uint8_t * >("ABCDEFGHIJKLMNOPQRSTUVXYZ");
  wire::icnx::TLV_RSA_SHA256 b (257, 26, var); //add 1 for NULL for strings
  wire::icnx::TLV_RSA_SHA256 c (b);

  wire::icnx::TLV_RSA_SHA256 d (b.NetworkSerialize ());
  wire::icnx::TLV_RSA_SHA256 e (b.XmlPrint ());

  wire::icnx::TLV_RSA_SHA256 f;
  f.SetData ("0123456789");
  wire::icnx::TLV_RSA_SHA256 *g = new wire::icnx::TLV_RSA_SHA256;
  *g = f;
