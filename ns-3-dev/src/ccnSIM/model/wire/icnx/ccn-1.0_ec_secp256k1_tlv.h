...
#ifndef _CCN_TLV_EC_SECP256K1_H_
#define _CCN_TLV_EC_SECP256K1_H_
/* CCN 1.0 TLV EC_SECP256K1 HDR packet
                    1                   2                   3
 ...
 **/
    class TLV_EC_SECP256K1:public TLV_RAWDATA
    {
    public:
   ...
   **/
      TLV_EC_SECP256K1 (const TLV_EC_SECP256K1 & tlv_msg);

  /**
   * @brief Copy constructor from serialized byte data
   **/
        TLV_EC_SECP256K1 (const TLV_RAW_DATA_t * rawData);

    /**
   * @brief Copy constructor from XML formatted string 
   **/
        TLV_EC_SECP256K1 (const std::string & xmlString);

  /**
    * @brief Copy constructor from type, length and raw data information
    **/
        TLV_EC_SECP256K1 (TLV_TYPE_t type, TLV_LENGTH_t length,
 ...
 tlvIdName() const;
  ...
  /**
    ...
    *
    **/
      virtual TLV_EC_SECP256K1 & operator = (const TLV_EC_SECP256K1 & other);
