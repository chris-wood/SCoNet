...
namespace wire
{
  namespace icnx
  {
    ...
    TLV_PAD::TLV_PAD (const TLV_PAD & tlv_msg)
      :TLV_RAWDATA(tlv_msg)
    {
      //m_serializedDataPtr = NULL;
     // m_DataPtr = NULL;
    ...
    TLV_PAD::TLV_PAD (const std::string & xmlString)
    ...
    TLV_PAD::TLV_PAD (const TLV_RAW_DATA_t * rawData)
      :TLV_RAWDATA(rawData)
    {
      //m_serializedDataPtr = NULL;
      //m_DataPtr = NULL;
    ...
    TLV_PAD::TLV_PAD (TLV_TYPE_t type, TLV_LENGTH_t length,
 ...
 const std::string 
 TLV_PAD::tlvIdName() const { return std::string("TLV_PAD"); }


    TLV_PAD & 
      TLV_PAD::operator = (const TLV_PAD & other)
    {
...
main ()
{
  ...
  wire::icnx::TLV_PAD b (257, 26, var); //add 1 for NULL for strings
  wire::icnx::TLV_PAD c (b);

  wire::icnx::TLV_PAD d (b.NetworkSerialize ());
  wire::icnx::TLV_PAD e (b.XmlPrint ());

  wire::icnx::TLV_PAD f;
  f.SetData ("0123456789");
  wire::icnx::TLV_PAD *g = new wire::icnx::TLV_PAD;
  *g = f;
  ...
  wire::icnx::TLV_PAD * h = new wire::icnx::TLV_PAD (5, 10, array);
  wire::icnx::TLV_PAD * j = new wire::icnx::TLV_PAD (*h);
