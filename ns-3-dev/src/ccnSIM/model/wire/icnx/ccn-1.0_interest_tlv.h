...
#ifndef _CCN_TLV_INTEREST_H_
#define _CCN_TLV_INTEREST_H_
 ...
 **/
    class TLV_INTEREST:public TLV_TLVDATA
    {
    public:
...
/**
 ...
 tlvIdName() const;
  ...
  /**
    ...
    *
    **/
      virtual TLV_INTEREST & operator = (const TLV_INTEREST & other);
