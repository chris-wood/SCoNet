...
#ifndef _CCN_TLV_KEYID_H_
#define _CCN_TLV_KEYID_H_
/* CCN 1.0 TLV KEYID HDR packet
                    1                   2                   3
 ...
 **/
    class TLV_KEYID:public TLV_RAWDATA
    {
    public:
 ...
 tlvIdName() const;
  ...
  /**
    ...
    *
    **/
      virtual TLV_KEYID & operator = (const TLV_KEYID & other);
