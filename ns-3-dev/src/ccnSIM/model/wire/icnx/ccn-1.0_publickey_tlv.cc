...
namespace wire
{
  namespace icnx
  {
    ...
    TLV_PUBLICKEY::TLV_PUBLICKEY ()
    {
      m_serializedDataPtr = NULL;
      m_DataPtr = NULL;
      m_length = 0;
      m_type = PUBLICKEY_TLV;
      m_dataChanged = true;
    ...
    TLV_PUBLICKEY::TLV_PUBLICKEY (const TLV_PUBLICKEY & tlv_msg)
      :TLV_RAWDATA(tlv_msg)
    {
      //m_serializedDataPtr = NULL;
     // m_DataPtr = NULL;
    ...
    TLV_PUBLICKEY::TLV_PUBLICKEY (const std::string & xmlString)
      :TLV_RAWDATA(xmlString)
    {
     // m_serializedDataPtr = NULL;
     // m_DataPtr = NULL;
     // m_type = MSG_NAME_PUBLICKEY_TLV;
      //XmlImplement (xmlString);
    }

    TLV_PUBLICKEY::TLV_PUBLICKEY (const TLV_RAW_DATA_t * rawData)
      :TLV_RAWDATA(rawData)
    {
      //m_serializedDataPtr = NULL;
     // m_DataPtr = NULL;
    ...
    TLV_PUBLICKEY::TLV_PUBLICKEY (TLV_TYPE_t type, TLV_LENGTH_t length,
 ...
 const std::string 
 TLV_PUBLICKEY::tlvIdName() const { return std::string("TLV_PUBLICKEY"); }

    TLV_BASE * 
    TLV_PUBLICKEY::Copy() const
    {
         return new TLV_PUBLICKEY( *this); 
    }

    TLV_PUBLICKEY & TLV_PUBLICKEY::operator = (const TLV_PUBLICKEY & other)
    {
...
#ifdef _SELF_TEST_TLV_PUBLICKEY_
#include <streambuf>
#include <ostream>
#include <iostream>
...
main ()
{
  ...
  wire::icnx::TLV_PUBLICKEY a;
  const uint8_t *var =
    reinterpret_cast < const uint8_t * >("ABCDEFGHIJKLMNOPQRSTUVXYZ");
  wire::icnx::TLV_PUBLICKEY b (257, 26, var); //add 1 for NULL for strings
  wire::icnx::TLV_PUBLICKEY c (b);

  wire::icnx::TLV_PUBLICKEY d (b.NetworkSerialize ());
  wire::icnx::TLV_PUBLICKEY e (b.XmlPrint ());

  wire::icnx::TLV_PUBLICKEY f;
  f.SetData ("0123456789");
  wire::icnx::TLV_PUBLICKEY *g = new wire::icnx::TLV_PUBLICKEY;
  *g = f;
