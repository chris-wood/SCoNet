...
namespace wire
{
  namespace icnx
  {
    ...
    TLV_INTEREST::TLV_INTEREST (const TLV_INTEREST & tlv_msg)
      :TLV_TLVDATA(tlv_msg)
    {
      //m_serializedDataPtr = NULL;
      //CopyFromTlv (tlv_msg);
    ...
    TLV_INTEREST::TLV_INTEREST (const TLV_RAW_DATA_t * rawData)
      :TLV_TLVDATA(rawData)
    {
      //m_serializedDataPtr = NULL;
    ...
    TLV_INTEREST::TLV_INTEREST (TLV_TYPE_t type, TLV_LENGTH_t length,
    ...
    TLV_INTEREST::TLV_INTEREST (const std::list<TLV_BASE *> &tlvDataList)
    ...
    TLV_INTEREST::TLV_INTEREST (const std::string & xmlString)
    ...
    TLV_BASE * 
    TLV_INTEREST::Copy() const
    {
         return new TLV_INTEREST( *this); 
    }

 const std::string 
 TLV_INTEREST::tlvIdName() const { return std::string("TLV_INTEREST"); }

    TLV_INTEREST & TLV_INTEREST::operator = (const TLV_INTEREST & other)
    {
...
#ifdef _SELF_TEST_INTEREST_TLV_
#include <streambuf>
#include <ostream>
#include <iostream>
#include <list>
...
main ()
{
  ...
  wire::icnx::TLV_INTEREST *b= new wire::icnx::TLV_INTEREST();
  {
  ...
  wire::icnx::TLV_INTEREST *e = new wire::icnx::TLV_INTEREST();
  e->SetData(new wire::icnx::TLV_INTEREST(*b));
  wire::icnx::TLV_INTEREST *d = new wire::icnx::TLV_INTEREST();
  d->SetTlvData(copy);
  ...
  wire::icnx::TLV_INTEREST *g1 = new wire::icnx::TLV_INTEREST (d->NetworkSerialize ());
  g1->CreateSerializedBuffer ();
  g1->XmlPrint (std::cout);
  g1->NetworkSerializePrint (std::cout, 4, " ");

  wire::icnx::TLV_INTEREST *g2 = new wire::icnx::TLV_INTEREST(d->XmlPrint ());
  ...
  wire::icnx::TLV_INTEREST *g = new wire::icnx::TLV_INTEREST (e->NetworkSerialize ());
  wire::icnx::TLV_INTEREST *h = new wire::icnx::TLV_INTEREST(e->XmlPrint ());
  cout << "delete e" << endl;
  delete e;
