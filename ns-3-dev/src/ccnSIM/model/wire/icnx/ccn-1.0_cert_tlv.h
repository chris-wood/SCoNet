...
#ifndef _CCN_TLV_CERT_H_
#define _CCN_TLV_CERT_H_
/* CCN 1.0 TLV CERT HDR packet
                    1                   2                   3
 ...
 **/
    class TLV_CERT:public TLV_RAWDATA
    {
    public:
 ...
 tlvIdName() const;
  ...
  /**
    ...
    *
    **/
      virtual TLV_CERT & operator = (const TLV_CERT & other);
