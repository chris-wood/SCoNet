...
#ifndef _CCN_TLV_KEYNAME_H_
#define _CCN_TLV_KEYNAME_H_
/* CCN 1.0 TLV KEYNAME HDR packet
                    1                   2                   3
 ...
 **/
    class TLV_KEYNAME:public TLV_RAWDATA
    {
    public:
   ...
   **/
      TLV_KEYNAME (const TLV_KEYNAME & tlv_msg);

  /**
   * @brief Copy constructor from serialized byte data
   **/
        TLV_KEYNAME (const TLV_RAW_DATA_t * rawData);

    /**
   * @brief Copy constructor from XML formatted string 
   **/
        TLV_KEYNAME (const std::string & xmlString);

  /**
    * @brief Copy constructor from type, length and raw data information
    **/
        TLV_KEYNAME (TLV_TYPE_t type, TLV_LENGTH_t length,
 ...
 tlvIdName() const;
  ...
  /**
    ...
    *
    **/
      virtual TLV_KEYNAME & operator = (const TLV_KEYNAME & other);
