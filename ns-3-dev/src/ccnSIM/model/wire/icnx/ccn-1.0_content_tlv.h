...
#ifndef _CCN_TLV_CONTENT_H_
#define _CCN_TLV_CONTENT_H_
/* CCN 1.0 TLV Content HDR packet
                    1                   2                   3
 ...
 **/
    class TLV_CONTENT:public TLV_TLVDATA
    {
    public:
...
/**
 ...
 tlvIdName() const;
  ...
  /**
    ...
    **/
      virtual TLV_CONTENT & 
        operator = (const TLV_CONTENT & other);
