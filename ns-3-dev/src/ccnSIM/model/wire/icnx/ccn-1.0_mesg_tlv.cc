...
namespace wire
{
  namespace icnx
  {
    ...
    TLV_MESG::TLV_MESG (const TLV_MESG & tlv_msg)
      : TLV_TLVDATA(tlv_msg)
    {
      //m_serializedDataPtr = NULL;
      //CopyFromTlv (tlv_msg);
    ...
    TLV_MESG::TLV_MESG (const TLV_RAW_DATA_t * rawData)
      : TLV_TLVDATA(rawData)
    {
      //m_serializedDataPtr = NULL;
    ...
    TLV_MESG::TLV_MESG (TLV_TYPE_t type, TLV_LENGTH_t length,
    ...
    TLV_MESG::TLV_MESG (const std::list<TLV_BASE *> &tlvDataList)
    ...
    TLV_MESG::TLV_MESG (const std::string & xmlString)
 ...
 const std::string 
 TLV_MESG::tlvIdName() const { return std::string("TLV_MESG"); }

    TLV_BASE * 
    TLV_MESG::Copy() const
    {
         return new TLV_MESG( *this); 
    }

    TLV_MESG & TLV_MESG::operator = (const TLV_MESG & other)
    {
...
#include "ccn-1.0_interest_msg_tlv.h"
...
main ()
{
  ...
  wire::icnx::TLV_MESG *b= new wire::icnx::TLV_MESG();
  {
  ...
  wire::icnx::TLV_MESG *e = new wire::icnx::TLV_MESG();
  e->SetData(new wire::icnx::TLV_MESG(*b));
  wire::icnx::TLV_MESG *d = new wire::icnx::TLV_MESG();
  d->SetTlvData(copy);
  ...
  wire::icnx::TLV_MESG *g1 = new wire::icnx::TLV_MESG (d->NetworkSerialize ());
  g1->CreateSerializedBuffer ();
  g1->XmlPrint (std::cout);
  g1->NetworkSerializePrint (std::cout, 4, " ");

  wire::icnx::TLV_MESG *g2 = new wire::icnx::TLV_MESG(d->XmlPrint ());
  ...
  wire::icnx::TLV_MESG *g = new wire::icnx::TLV_MESG (e->NetworkSerialize ());
  wire::icnx::TLV_MESG *h = new wire::icnx::TLV_MESG(e->XmlPrint ());
  cout << "delete e" << endl;
  delete e;
