...
#ifndef _CCN_TLV_LINK_H_
#define _CCN_TLV_LINK_H_
/* CCN 1.0 TLV LINK HDR packet
                    1                   2                   3
 ...
 **/
    class TLV_LINK:public TLV_RAWDATA
    {
    public:
 ...
 tlvIdName() const;
  ...
  /**
    ...
    *
    **/
      virtual TLV_LINK & operator = (const TLV_LINK & other);
