...
namespace wire
{
  namespace icnx
  {
    ...
    TLV_KEYNAME::TLV_KEYNAME (const TLV_KEYNAME & tlv_msg)
      :TLV_RAWDATA(tlv_msg)
    {
      //m_serializedDataPtr = NULL;
     // m_DataPtr = NULL;
    ...
    TLV_KEYNAME::TLV_KEYNAME (const std::string & xmlString)
      :TLV_RAWDATA(xmlString)
    {
     // m_serializedDataPtr = NULL;
     // m_DataPtr = NULL;
     // m_type = MSG_NAME_KEYNAME_TLV;
      //XmlImplement (xmlString);
    }

    TLV_KEYNAME::TLV_KEYNAME (const TLV_RAW_DATA_t * rawData)
      :TLV_RAWDATA(rawData)
    {
      //m_serializedDataPtr = NULL;
     // m_DataPtr = NULL;
    ...
    TLV_KEYNAME::TLV_KEYNAME (TLV_TYPE_t type, TLV_LENGTH_t length,
 ...
 const std::string 
 TLV_KEYNAME::tlvIdName() const { return std::string("TLV_KEYNAME"); }
    TLV_BASE * 
    TLV_KEYNAME::Copy() const
    {
         return new TLV_KEYNAME( *this); 
    }


    TLV_KEYNAME & TLV_KEYNAME::operator = (const TLV_KEYNAME & other)
    {
...
main ()
{
  ...
  wire::icnx::TLV_KEYNAME a;
  const uint8_t *var =
    reinterpret_cast < const uint8_t * >("ABCDEFGHIJKLMNOPQRSTUVXYZ");
  wire::icnx::TLV_KEYNAME b (257, 26, var); //add 1 for NULL for strings
  wire::icnx::TLV_KEYNAME c (b);

  wire::icnx::TLV_KEYNAME d (b.NetworkSerialize ());
  wire::icnx::TLV_KEYNAME e (b.XmlPrint ());

  wire::icnx::TLV_KEYNAME f;
  f.SetData ("0123456789");
  wire::icnx::TLV_KEYNAME *g = new wire::icnx::TLV_KEYNAME;
  *g = f;
