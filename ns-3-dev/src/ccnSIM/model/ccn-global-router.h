...
#ifndef CCN_GLOBAL_ROUTER_H
#define CCN_GLOBAL_ROUTER_H
...
/**
 * @ingroup ccn
 * @brief Class representing global router interface for ccnSIM
 */
...
public:
  ...
  /**
   * @brief Helper function to get smart pointer to ccn::L3Protocol object (basically, self)
   */
  Ptr<L3Protocol>
  GetL3Protocol () const;
   ...
   * @param ccn GlobalRouter of another node
   */
  void
  AddIncidency (Ptr< Face > face, Ptr< GlobalRouter > ccn);
