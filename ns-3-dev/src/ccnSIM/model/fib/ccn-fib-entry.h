...
#ifndef _CCN_FIB_ENTRY_H_
#define	_CCN_FIB_ENTRY_H_
...
public:
   ...
   */
  FaceMetric (Ptr<Face> face, int32_t cost, int32_t rank)
    : m_face (face)
    , m_status (CCN_FIB_YELLOW)
    , m_routingCost (cost)
	, m_rank (rank)
    , m_sRtt   (Seconds (0))
    , m_rttVar (Seconds (0))
...
struct FaceMetricContainer
{
  ...
  typedef boost::multi_index::multi_index_container<
    ...
    boost::multi_index::indexed_by<
      ...
      // List of available faces ordered by (m_rank)
      boost::multi_index::ordered_non_unique<
             boost::multi_index::tag<i_rank>,
             boost::multi_index::const_mem_fun<FaceMetric,int32_t,&FaceMetric::GetRank>
           >,
...
public:
   ...
   */
  void AddOrUpdateRoutingMetric (Ptr<Face> face, int32_t metric, int32_t rank);
