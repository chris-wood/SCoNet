...
#ifndef _CCN_FIB_IMPL_H_
#define	_CCN_FIB_IMPL_H_
...
{
public:
  typedef ccnSIM::trie_with_policy<
    Name,
    ccnSIM::smart_pointer_payload_traits<EntryImpl>,
...
public:
  typedef ccnSIM::trie_with_policy< Name,
                                    ccnSIM::smart_pointer_payload_traits<EntryImpl>,
                                    ccnSIM::counting_policy_traits > super;
  ...
  virtual Ptr<Entry>
  Add (const Name &prefix, Ptr<Face> face, int32_t metric, int32_t rank);

  virtual Ptr<Entry>
  Add (const Ptr<const Name> &prefix, Ptr<Face> face, int32_t metric, int32_t rank);
