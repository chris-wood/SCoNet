...
#ifndef CCNSIM_PER_OUT_FACE_LIMITS_H
#define CCNSIM_PER_OUT_FACE_LIMITS_H
...
PerOutFaceLimits<Parent>::GetTypeId (void)
{
  static TypeId tid = TypeId ((super::GetTypeId ().GetName ()+"::PerOutFaceLimits").c_str ())
    ...
    .AddAttribute ("Limit", "Limit type to be used (e.g., ns3::ccn::Limits::Window or ns3::ccn::Limits::Rate)",
                   StringValue ("ns3::ccn::Limits::Window"),
...
#endif // CCNSIM_PER_OUT_FACE_LIMITS_H
