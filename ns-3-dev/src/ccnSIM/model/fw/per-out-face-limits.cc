...
//  */
class BestRoute::PerOutFaceLimits : public ::ns3::ccn::fw::PerOutFaceLimits<BestRoute> { };

/**
 * \brief Strategy implementing per-out-face limits on top of Flooding strategy
 */
class Flooding::PerOutFaceLimits : public ::ns3::ccn::fw::PerOutFaceLimits<Flooding> { };

/**
 * \brief Strategy implementing per-out-face limits on top of SmartFlooding strategy
 */
class SmartFlooding::PerOutFaceLimits : public ::ns3::ccn::fw::PerOutFaceLimits<SmartFlooding> { };
#endif
