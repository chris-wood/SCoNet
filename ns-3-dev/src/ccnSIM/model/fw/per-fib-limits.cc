...
//  */
class BestRoute::PerOutFaceLimits::PerFibLimits : public ::ns3::ccn::fw::PerFibLimits< ::ns3::ccn::fw::PerOutFaceLimits<BestRoute> > { };

/**
 * \brief Strategy implementing per-fib-per-out-face limits on top of Flooding strategy
 */
class Flooding::PerOutFaceLimits::PerFibLimits : public ::ns3::ccn::fw::PerFibLimits< ::ns3::ccn::fw::PerOutFaceLimits<Flooding> > { };

/**
 * \brief Strategy implementing per-fib-per-out-face limits on top of SmartFlooding strategy
 */
class SmartFlooding::PerOutFaceLimits::PerFibLimits : public ::ns3::ccn::fw::PerFibLimits< ::ns3::ccn::fw::PerOutFaceLimits<SmartFlooding> > { };
