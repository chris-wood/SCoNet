...
NS_LOG_COMPONENT_DEFINE ("ccn.L3Protocol");
...
{
  static TypeId tid = TypeId ("ns3::ccn::L3Protocol")
    .SetGroupName ("ccn")
    .SetParent<Object> ()
    .AddConstructor<L3Protocol> ()
    .AddAttribute ("FaceList", "List of faces associated with ccn stack",
                   ObjectVectorValue (),
 ...
 * by setting the node in the ccn stack
 */
void
...
L3Protocol::AddFace (const Ptr<Face> &face)
{
  ...
  face->RegisterProtocolHandlers (MakeCallback (&ForwardingStrategy::OnInterest, m_forwardingStrategy),
                                  ...
                                  MakeCallback (&ForwardingStrategy::OnInterestResponse, m_forwardingStrategy));
