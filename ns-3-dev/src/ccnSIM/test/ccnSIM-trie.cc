...
using namespace std;
using namespace ns3;
using namespace ccn::ccnSIM;
using namespace boost;

NS_LOG_COMPONENT_DEFINE ("ccn.Trie");
...
TrieTest::DoRun ()
{
  ...
  // Ptr<ccn::App> app = CreateObject<ccn::App> ();
  // node->AddApplication (app);
  
  // ObjectFactory factory ("ns3::ccn::fib::Default");
  
  // Ptr<ccn::Fib> fib = factory.Create<ccn::Fib> ();
  // node->AggregateObject (fib);
  // Ptr<ccn::Face> face = CreateObject<ccn::AppFace> (app);

  // fib->Add (lexical_cast<ccn::Name> ("/bla"), face, 1);
  // fib->Add (lexical_cast<ccn::Name> ("/bla/1"), face, 1);
  // fib->Add (lexical_cast<ccn::Name> ("/bla/2"), face, 1);
  // fib->Add (lexical_cast<ccn::Name> ("/bla/3"), face, 1);
  // fib->Add (lexical_cast<ccn::Name> ("/bla/1/1"), face, 1);
  // fib->Add (lexical_cast<ccn::Name> ("/bla/1/2"), face, 1);
