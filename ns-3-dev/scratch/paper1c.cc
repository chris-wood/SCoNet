...
main (int argc, char *argv[])
{
  ...
  icnxHelper.SetContentStore ("ns3::ccn::cs::UtilityCaching", "ConfigureUtilities", "Lru2-hash1.xml"); // can set cache size this way
  icnxHelper.Install (nodes.Get (1));
  icnxHelper.SetContentStore ("ns3::ccn::cs::UtilityCaching", "ConfigureUtilities", "Lru2-hash2.xml"); // can set cache size this way
  //icnxHelper.SetContentStore ("ns3::ccn::cs::UtilityCaching", "ConfigureUtilities", "Lru2-hash2b.xml"); // can set cache size this way
  ...
  // Consumer
  //ccn::AppHelper consumerHelper ("ns3::ccn::ConsumerZipfMandelbrot");
  ...
  consumerHelper2.SetAttribute ("Frequency", StringValue ("6")); // 4 interests a second
  ...
  consumerHelper4.SetAttribute ("Frequency", StringValue ("2")); // 1 interests a second
