...
Packet::EnableChecking ();
  ...
  ccnHelper.SetForwardingStrategy ("ns3::ccn::fw::SIFAH");
  //ccnHelper.SetForwardingStrategy ("ns3::ccn::fw::ccn");
  ccnHelper.SetDefaultRoutes(false);
...
p2p.EnablePcapAll ("myfirst");*/
  ...
  consumerHelper.SetAttribute ("HopLimit", UintegerValue (155));
  consumerHelper.SetAttribute ("KeyIdRestrSize", UintegerValue (2));
  consumerHelper.SetAttribute ("ObjectHashSize", UintegerValue (32));
  //consumerHelper.SetAttribute ("NameNonce", UintegerValue (5));
  consumerHelper.Install (consumerNodes);

  ccn::AppHelper producerHelper ("ns3::ccn::Producer");
  producerHelper.SetPrefix (prefix);
  producerHelper.SetAttribute ("PayloadSize", StringValue("1024"));
  //producerHelper.SetAttribute ("NameNonce", UintegerValue (5));
  producerHelper.SetAttribute ("KeyIdRestrSize", UintegerValue (2));
  producerHelper.SetAttribute ("ObjectHashSize", UintegerValue (32));
  ...
  ccn::AppDelayTracer::InstallAll("results/grid-Delay.txt");
  Simulator::Run ();
  Simulator::Destroy ();
